...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> committee detail clearfix"<?php print $attributes; ?>>
  ...
  <div class="tile-wrapper">
    <?php print render($content['field_committee_chairman']); ?>
    <?php print render($content['field_committee_vice_chairman']); ?>
    <?php print render($content['field_committee_spokesman']); ?>
    <?php print render($content['field_committee_members']); ?>
    <?php print render($content['field_committee_alt_members']); ?>
  </div>
</article>